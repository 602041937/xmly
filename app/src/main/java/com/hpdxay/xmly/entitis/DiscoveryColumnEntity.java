...
/**
 * Entity mapped to table "DISCOVERY_COLUMN_ENTITY".
 */
public class DiscoveryColumnEntity {
    ...
    public DiscoveryColumnEntity() {
    }

    public DiscoveryColumnEntity(Long id) {
        this.id = id;
    }

    public DiscoveryColumnEntity(Long id, Integer orderNum, String title, String subtitle, String coverPath, String contentType, String url, String sharePic, Boolean enableShare, Boolean isHot, Boolean isExternalUrl, Integer contentUpdatedAt) {
        this.id = id;
