...
/** 
 * DAO for table "DISCOVERY_COLUMN_ENTITY".
*/
public class DiscoveryColumnEntityDao extends AbstractDao<DiscoveryColumnEntity, Long> {

    public static final String TABLENAME = "DISCOVERY_COLUMN_ENTITY";

    /**
     * Properties of entity DiscoveryColumnEntity.<br/>
    ...
    */
    ...
    public DiscoveryColumnEntityDao(DaoConfig config) {
        super(config);
    }
    
    public DiscoveryColumnEntityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DISCOVERY_COLUMN_ENTITY\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DISCOVERY_COLUMN_ENTITY\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, DiscoveryColumnEntity entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public DiscoveryColumnEntity readEntity(Cursor cursor, int offset) {
        DiscoveryColumnEntity entity = new DiscoveryColumnEntity( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, DiscoveryColumnEntity entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(DiscoveryColumnEntity entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(DiscoveryColumnEntity entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
